...
const variantClasses: Record<Variant, string> = {
  ...
  secondary:
    "inline-flex items-center justify-center gap-2 rounded-full border border-royal-bright/20 bg-cream px-6 py-3 text-sm font-semibold text-royal-bright transition-colors duration-200 hover:border-royal-bright hover:bg-cream/80",
  ghost:
    "inline-flex items-center justify-center gap-2 rounded-full bg-transparent px-6 py-3 text-sm font-semibold text-royal-bright transition-colors duration-200 hover:text-royal",
};
